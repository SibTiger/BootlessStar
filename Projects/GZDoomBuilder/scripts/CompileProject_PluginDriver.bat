...
CALL :CompileProject_CompilePlugins_BuilderEffects || (CALL :CaughtErrorSignal& EXIT /B 1)
CALL :CompileProject_CompilePlugins_ColorPicker || (CALL :CaughtErrorSignal& EXIT /B 1)
CALL :CompileProject_CompilePlugins_CommentsPanel || (CALL :CaughtErrorSignal& EXIT /B 1)
CALL :CompileProject_CompilePlugins_NodesViewer || (CALL :CaughtErrorSignal& EXIT /B 1)
CALL :CompileProject_CompilePlugins_TagRange || (CALL :CaughtErrorSignal& EXIT /B 1)
CALL :CompileProject_CompilePlugins_TagExplorer || (CALL :CaughtErrorSignal& EXIT /B 1)
