...
REM ----
REM Builder Effects
CALL :CompileProject_CheckResources_CheckTargets_Process "%ProjectDirectory.PathPluginBuilderEffects%" || EXIT /B 1
CALL :CompileProject_CheckResources_CheckTargets_Process "%ProjectDirectory.PathPluginBuilderEffectsAssembly%" || EXIT /B 1
REM ----
REM Builder Modes
...
REM ----
REM Color Picker
CALL :CompileProject_CheckResources_CheckTargets_Process "%ProjectDirectory.PathPluginColorPicker%" || EXIT /B 1
CALL :CompileProject_CheckResources_CheckTargets_Process "%ProjectDirectory.PathPluginColorPickerAssembly%" || EXIT /B 1
REM ----
REM Comments Panel
...
REM ----
REM Nodes Viewer
CALL :CompileProject_CheckResources_CheckTargets_Process "%ProjectDirectory.PathPluginNodesViewer%" || EXIT /B 1
CALL :CompileProject_CheckResources_CheckTargets_Process "%ProjectDirectory.PathPluginNodesViewerAssembly%" || EXIT /B 1
REM ----
REM Tag Explorer
CALL :CompileProject_CheckResources_CheckTargets_Process "%ProjectDirectory.PathPluginTagExplorer%" || EXIT /B 1
CALL :CompileProject_CheckResources_CheckTargets_Process "%ProjectDirectory.PathPluginTagExplorerAssembly%" || EXIT /B 1
REM ----
REM Tag Range
