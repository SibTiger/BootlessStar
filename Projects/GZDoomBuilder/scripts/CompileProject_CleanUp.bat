...
SET TaskCaller_CallLong=DEL /F /Q "%ProjectDirectory.DirCompiledTarget%\*.pdb" "%ProjectDirectory.DirCompiledTarget%\Builder.xml" "%ProjectDirectory.DirCompiledTarget%\Plugins\*.pdb" "%ProjectDirectory.DirCompiledTarget%\Plugins\Builder.exe" "%ProjectDirectory.DirCompiledTarget%\Plugins\Builder.xml" "%ProjectDirectory.DirCompiledTarget%\Plugins\SharpCompress.3.5.dll" "%ProjectDirectory.DirCompiledTarget%\Plugins\TrackBar.dll" "%ProjectDirectory.DirCompiledTarget%\Plugins\SlimDX.dll"
