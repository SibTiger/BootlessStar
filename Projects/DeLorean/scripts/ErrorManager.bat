...
REM # =============================================================================================
REM # Parameters: [{string} File or Path]
...
REM # =============================================================================================
REM # Documentation: When the program reaches an error during the backup or restore process, this function will be called.  This function will accordingly output the error message on the log [depending on the ToggleLog var] and display the message on the terminal.
REM # =============================================================================================
:CaughtErrorSignal
...
REM # =============================================================================================
:CaughtIssueSignal
IF %ToggleLog% EQU True CALL :CaughtIssueSignal_LogError
CALL :CaughtIssueSignal_DisplayError
GOTO :EOF
...
REM # Documentation: Display the error message on the user's screen from the terminal buffer.
REM # =============================================================================================
:CaughtIssueSignal_DisplayError
IF %UseBell% GEQ 1 (ECHO %SND_BELL% %SND_BELL% %SND_BELL% %SND_BELL%)
ECHO %SeparatorLong%
ECHO.&ECHO.
ECHO ^<!^>       Critical Issue Was Discovered!       ^<!^>
ECHO %SeparatorLong%
ECHO.
ECHO Caught an Issue Signal!  The operation has been terminated!
...
REM # Documentation: Log the error message to the ASCII file located within the filesystem.
REM # =============================================================================================
:CaughtIssueSignal_LogError
(ECHO %SeparatorLong%)>> "%STDOUT%"
(ECHO.&ECHO.)>> "%STDOUT%"
(ECHO ^<!^>       Critical Issue Was Discovered!       ^<!^>)>> "%STDOUT%"
(ECHO %SeparatorLong%)>> "%STDOUT%"
(ECHO.)>> "%STDOUT%"
(ECHO Caught an Issue Signal!  The operation has been terminated!)>> "%STDOUT%"
(ECHO.)>> "%STDOUT%"
GOTO :EOF